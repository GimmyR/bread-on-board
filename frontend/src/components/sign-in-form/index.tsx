...
export default function SignInForm({ isSigningUp = false } : { isSigningUp?: boolean }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="d-flex flex-column align-items-center col-12 col-md-9 mt-5 py-5 px-3 px-lg-0 bg-light">
            <h1 className="text-success mb-5">Login</h1>
            {error && <div className="alert alert-danger col-12 col-md-6 mb-4" role="alert">{ error }</div>}
            ...
            <div className="d-flex flex-column col-8 col-md-7 col-lg-6 mb-5">
